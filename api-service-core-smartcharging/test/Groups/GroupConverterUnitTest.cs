...
{
    public class GroupConverterUnitTest
    {
        ...
        [Fact]
        public void Convert_Group_To_GroupResponse()
        {
            int identifier = 123;
            var value = new Group { Identifier = identifier, Name = "test name", Capacity = 200 };
            var data = new GroupResponse { Identifier = identifier, Name = "test name", Capacity = 200 };
